...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('body-scroll-lock'), require('vue'), require('dayjs')) :
  typeof define === 'function' && define.amd ? define(['exports', 'body-scroll-lock', 'vue', 'dayjs'], factory) :
  (global = global || self, factory(global.VueDatepicker = {}, global.BodyScrollLock, global.Vue, global.Dayjs));
}(this, (function (exports, bodyScrollLock, Vue, dayjs) { 'use strict';
  ...
  var VDPickerAgenda = baseMixins$b.extend({
    ...
    watch: {
      ...
      mode: function mode(_mode) {
        ...
        bodyScrollLock.enableBodyScroll(this.$refs.body);
        this.$nextTick(function () {
          bodyScrollLock.disableBodyScroll(_this2.$el.querySelector('.vd-picker__years'));
        });
      }
    },
    methods: {
